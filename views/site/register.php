...
<div class="row-fluid main">
    ...
    if (isset($user) && $user instanceof \app\models\User) {
        ...
        <div class="col-sm-6 text-justify shadow-box">
            ...
            <div class="col-sm-12">
                <hr/>
                Регистрацията при нас Ви дава възможност да обявявате вашите продукти и/или услуги, като по този начин
                тази информация ще достигне до повече хора. Какво предлагаме:
                <ul>
                    <li>Възможност да рекламирате Вашият бизнес.</li>
                    <li>Сами избирате срока на вашата обява/промоция.</li>
                    <li>От един профил, може да обявите различни сфери от Вашата дейност.</li>
                </ul>
                <a class="btn btn-primary"
